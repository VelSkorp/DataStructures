    ...
    public class BinaryTree<T> where T:IComparable
    {
        ...
        public BinaryTreeNode<T> Add(BinaryTreeNode<T> node,BinaryTreeNode<T> currentNode = null)
        {
            ...
            return (result = node.Data.CompareTo(currentNode.Data)) == 0 ? currentNode : result < 0 ? currentNode.LeftNode == null ?
                (currentNode.LeftNode = node) : Add(node, currentNode.LeftNode) : currentNode.RightNode == null ? 
        ...
        public BinaryTreeNode<T> FindeNode(T data,BinaryTreeNode<T> startWithNode = null)
        {
            startWithNode = startWithNode ?? RootNode;

            int result;

            return (result = data.CompareTo(startWithNode.Data)) == 0 ? startWithNode : result < 0 ? startWithNode.LeftNode == null ? 
                null : FindeNode(data, startWithNode.LeftNode) : startWithNode.RightNode == null ? null : FindeNode(data, startWithNode.RightNode);
        }
